...
public class InsertionSortApp {
    ...
    public static void insertionSort(Employee[] list, String key) {
        ...
        for (int i = 1; i < list.length; i++) {
            ...
            Employee temp = list[i];   // And this shall be putted before the inner loop
            System.arraycopy(list, j, list, j + 1, i - j); // This can be deleted if change elements in the above loop
            list[j] = temp;
        }
    }
